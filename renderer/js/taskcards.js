...
function generateTaskCard(task, state) {
    if(state == "done"){
        return `
        <div class="taskCard" id="${task.id}">
            <div class="taskCheckBox">
                <label for="task" class="item">
                    <input type="checkbox" id="${task.id}" name="habitCheckId" value="${task.id}" class="habitCheckId" checked>
                    <span class="cbx">
            ...
            <div class="deleteTaskButton" data-id="${task.id}">
    ...
    <div class="taskCard" id="${task.id}">
        <div class="taskCheckBox">
            <label for="task" class="item">
                <input type="checkbox" id="${task.id}" name="habitCheckId" value="${task.id}" class="habitCheckId" >
                <span class="cbx">
                    <svg width="14px" height="12px" viewBox="0 0 14 12">
                        <polyline points="1 7.6 5 11 13 1"></polyline>
                    </svg>
