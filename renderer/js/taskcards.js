...
function generateTaskCard(task, state) {
    if(state == "done"){
        return `
        <div class="taskCard" id="${task._id}">
            <div class="taskCheckBox">
                <label for="task" class="item">
                    <input type="checkbox" id="${task._id}" name="habitCheckId" value="${task._id}" class="habitCheckId" checked>
                    <span class="cbx">
                        <svg width="14px" height="12px" viewBox="0 0 14 12">
                            <polyline points="1 7.6 5 11 13 1"></polyline>
                        </svg>
                    </span>
                    <span class="cbx-lbl">${task.title}</span>
                </label>
            </div>
            <div class="deleteTaskButton" data-id="${task._id}">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 69 14" class="deleteTaskIcon bin-top">
                    ...
                    <defs>
                        <clipPath class="clip0_35_24">
                            <rect fill="white" height="14" width="69"></rect>
                        </clipPath>
                    </defs>
                </svg>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 69 57" class="deleteTaskIcon bin-bottom">
    ...
    <div class="taskCard" id="${task._id}">
        <div class="taskCheckBox">
            <label for="task" class="item">
                <input type="checkbox" id="${task._id}" name="habitCheckId" value="${task._id}" class="habitCheckId" >
                <span class="cbx">
                    <svg width="14px" height="12px" viewBox="0 0 14 12">
                        <polyline points="1 7.6 5 11 13 1"></polyline>
                    </svg>
